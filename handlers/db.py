...
class UpbitCoin(Base):
    __tablename__ = 'upbit_coins'

    id = Column(Integer, primary_key=True)
    code = Column(String)
    date = Column(String)
    time = Column(String)
    my_timestamp = Column(String)
    timestamp = Column(String)
    trade_timestamp = Column(String)
    trade_price = Column(Float)
    trade_volume= Column(Float)
    hoga_timestamp = Column(String)
    total_ask_size = Column(Float)
    total_bid_size = Column(Float)
    sell_hoga15 = Column(Float)
    sell_hoga14 = Column(Float)
    sell_hoga13 = Column(Float)
    sell_hoga12 = Column(Float)
    sell_hoga11 = Column(Float)
    sell_hoga10 = Column(Float)
    sell_hoga9 = Column(Float)
    sell_hoga8 = Column(Float)
    sell_hoga7 = Column(Float)
    ...
    buy_hoga9 = Column(Float)
    buy_hoga10 = Column(Float)
    buy_hoga11 = Column(Float)
    buy_hoga12 = Column(Float)
    buy_hoga13 = Column(Float)
    buy_hoga14 = Column(Float)
    buy_hoga15 = Column(Float)
    sell_hoga15_stack = Column(Float)
    sell_hoga14_stack = Column(Float)
    sell_hoga13_stack = Column(Float)
    sell_hoga12_stack = Column(Float)
    sell_hoga11_stack = Column(Float)
    sell_hoga10_stack = Column(Float)
    sell_hoga9_stack = Column(Float)
    sell_hoga8_stack = Column(Float)
    sell_hoga7_stack = Column(Float)
    ...
    buy_hoga9_stack = Column(Float)
    buy_hoga10_stack = Column(Float)
    buy_hoga11_stack = Column(Float)
    buy_hoga12_stack = Column(Float)
    buy_hoga13_stack = Column(Float)
    buy_hoga14_stack = Column(Float)
    buy_hoga15_stack = Column(Float)
...
if __name__ == '__main__':
    ...
    UpbitCoin.__table__.create(bind=db, checkfirst=True)
